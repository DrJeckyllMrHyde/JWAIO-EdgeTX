...
-- Fichier : lib/ui.lua
-- Version : 0.3.1 Alpha
-- Role    : rendu TX16S Mk3 800x480 depuis le repere logique TX15 480x320.
-- ============================================================================

return function(config, util)
  local M = {}
  -- Police native XXS de la Mk3 ; pas de drapeau numerique code en dur.
  ...
  local function drawBackground(t, widget)
    ...
    -- Le tampon du widget EdgeTX coupe le debordement. En 800x480,
    -- le fond TX15 est agrandi a 167% et recadre au centre.
  ...
  function M.draw(widget)
    ...
    if zone.w < 600 or zone.h < 380 then
